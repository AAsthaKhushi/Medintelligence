...
export function PrescriptionsList({ onViewPrescription, onChatAboutPrescription }: PrescriptionsListProps) {
      ...
      {!prescriptions || prescriptions.length === 0 ? (
        ...
        <div className="space-y-4">
          {prescriptions.map((prescription) => (
            <div key={prescription.id} className="border border-slate-200 rounded-lg p-4 hover:bg-slate-50 transition-colors">
                  ...
                  {prescription.processingStatus === 'completed' ? (
                    <>
                      ...
                      <Button
                        ...
                        className="text-slate-600 hover:text-slate-700 justify-start"
                      >
                        <i className="fas fa-comment mr-2"></i>Ask AI
                      </Button>
                    </>
                  ) : (
                    <Button variant="ghost" size="sm" disabled className="text-slate-400 justify-start">
                      <i className="fas fa-eye mr-2"></i>Processing...
                    </Button>
                  )}
                </div>
              </div>
